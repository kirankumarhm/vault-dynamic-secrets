# ==============================================================================
# Module: modules/vault_configuration
# Purpose: Declaratively manages HashiCorp Vault business resources:
#          - Cryptographic file audit device (/vault/data/vault_audit.log)
#          - Dynamic PostgreSQL database secrets engine
#          - Demo & Production ephemeral database roles
#          - Least-privilege ACL policies
#          - Secret-Less Kubernetes Authentication backend & role bindings
# ==============================================================================
...
resource "vault_kubernetes_auth_backend_role" "payments_app_role" {
  ...
  bound_service_account_names      = [var.app_service_account_name]
